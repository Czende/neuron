...
<head>
	...
	<script src="js/recountXOR.js" async defer></script>
</head>
<body style="padding-top: 50px; background:#222;">
	  ...
	  <div class="container">
	    ...
	    <div id="navbar" class="collapse navbar-collapse">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="active"><a href="../xor/">XOR</a></li>
	      </ul>
	    </div><!--/.nav-collapse -->
	  </div>
	</nav>
    ...
    <div class="container">
		<div class="row">
			<h3 class="text-center">Neuron vs. <strong>XOR</strong></h3>
			<div class="col-md-6 col-md-offset-3">
				...
				<table class="table table-bordered" width="50%" style="background: #fff;">
					<thead class="thead-inverse">
						<tr>
							<th class="text-center alert-success" colspan="5">XOR</th>
						</tr>
					</thead>
					<tbody class="recountContainer">
						<tr>
							...
							<td class="text-center col-md-2 btn-success"><strong>Y<sub>XOR</sub></strong></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="text-center"><span data-name="a2">0</span></td>
							<td class="text-center"><span data-name="b2">1</span></td>
						...
						<tr>
							<td class="text-center"><span data-name="a3">1</span></td>
							<td class="text-center"><span data-name="b3">0</span></td>
						...
						<tr>
							...
							<td class="text-center btn-danger"><span data-name="y4">1</span></td>
							<td class="text-center btn-success"><span data-name="y4or">0</span></td>
						</tr>
					</tbody>
				</table>

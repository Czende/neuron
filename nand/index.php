...
<head>
	...
	<script src="js/recountNAND.js"></script>
</head>
<body style="padding-top: 50px; background:#EEEEEE;">
	  ...
	  <div class="container">
	    ...
	    <div id="navbar" class="collapse navbar-collapse">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="active"><a href="../nand/">NAND</a></li>
    ...
    <div class="container">
		<div class="row">
			<h3 class="text-center">Neuron vs. <strong>NAND</strong></h3>
			<div class="col-md-6 col-md-offset-3">
				...
				<table class="table table-bordered" width="50%" style="background: #fff;">
					<thead class="thead-inverse">
						<tr>
							<th class="text-center alert-success" colspan="5">NAND</th>
						</tr>
					</thead>
					<tbody class="recountContainer">
						<tr>
							...
							<td class="text-center col-md-2 btn-success"><strong>Y<sub>NAND</sub></strong></td>
						</tr>
						<tr>
							...
							<td class="text-center btn-danger"><span data-name="y1">0</span></td>
							<td class="text-center btn-success"><span data-name="y1or">1</span></td>
						</tr>
						<tr>
